...
namespace SaveTime
{
    ...
    public sealed partial class AppShell : Page, INotifyPropertyChanged
    {
        ...
        {
            if (this.AppFrame.CurrentSourcePageType != typeof(SettingPage))
            {
                this.AppFrame.Navigate(typeof(SettingPage), null);
            }
        }
        ...
        private void OnNavigatedToPage(object sender, NavigationEventArgs e)
        {
            ...
            if (e.Content is Page && e.Content != null)
            {
                ...
                //set PageHeader
                this.PageHeaderText = control.Name;
            }
